---
version: alpha
name: "notion（refero styles の写し）"
description: "warm paper notebook under afternoon sun"
omitted:
  - section: typography
...
colors:
  ...
  dark-card: "#1f1d1c"
  dark-surface: "#1f1d1c"
  dark-surface-2: "#2b2926"
  dark-ink: "#ededed"
  dark-ink-mid: "#c4c2bf"
  dark-ink-soft: "#adadad"
  dark-sub: "#b2b2b2"
  dark-muted: "#9f9f9e"
  dark-line: "#3e3e3c"
  dark-line-2: "#4d4d4c"
  dark-hair: "#31312f"
  dark-accent: "#0080f3"
  dark-accent-2: "#088aff"
  dark-accent-wash: "#102131"
  dark-accent-soft: "#0e3150"
rounded:
  cards: 12px
  pills: 9999px
  small: 4px
