...
ICONS = {
    ...
    # ふたりカード＝1枚の共同カードを真ん中でわける。カード＋ミシン目の点線だけの簡素な形
    "futaricard": '<rect x="20" y="32" width="60" height="38" rx="6"/>'
                  '<line x1="20" y1="43" x2="80" y2="43"/>'
                  '<line x1="50" y1="43" x2="50" y2="70" stroke-dasharray="0.1 6.5"/>',
    # 残高計算＝電卓
